...
# Links
param_to_param_tilde(::Poisson, param::Vector{T}) where T = param_to_param_tilde.(ExponentialLink, param, zero(T))
param_tilde_to_param(::Poisson, param_tilde::Vector{T}) where T = param_tilde_to_param.(ExponentialLink, param_tilde, zero(T))
jacobian_param_tilde(::Poisson, param_tilde::Vector{T}) where T = Diagonal(jacobian_param_tilde.(ExponentialLink, param_tilde, zero(T)))
