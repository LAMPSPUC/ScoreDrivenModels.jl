...
"""
function LBFGS(model::ScoreDrivenModel{D, T}, n_initial_points::Int; f_tol::T = T(1e-6), g_tol::T = T(1e-6),
...
function LBFGS(model::ScoreDrivenModel{D, T}, initial_points::Vector{Vector{T}}; f_tol::T = T(1e-6), g_tol::T = T(1e-6),
